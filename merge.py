...
def start_interview():
    ...
    question_csv_file_path = r"C:\Users\shubh\Downloads\questonaire.csv"  # Replace with your file path
    answer_csv_file_path = r"C:\Users\shubh\Downloads\answers445.csv" # Replace with your file path
